...
const Nav = () => {
  ...
  return (
    <div className="header__component">
      <div className="logo__bar">BlaBlaCart</div>
      ...
      <button onClick={showHideCart} className="cart">
        ...
        <div className="cart__items">{cartItems.length}</div>
